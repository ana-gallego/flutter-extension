...
export function activate(context: ExtensionContext) {
	...
	context.subscriptions.push(commands.registerCommand('extension.wrapInContainer', () =>
		insertSnippet("${1:Container}(\n" + getSpacer() + "child: $2", "\n)", getSpacer())
	));
	context.subscriptions.push(commands.registerCommand('extension.wrapInStack', () =>
		insertSnippet("${1:Stack}(\n" + getSpacer() + "children: [\n" + getSpacer().repeat(2), "$2\n" + getSpacer() + "]\n)", getSpacer().repeat(2))
	));
	context.subscriptions.push(commands.registerCommand('extension.wrapInColumn', () =>
		insertSnippet("${1:Column}(\n" + getSpacer() + "children: [\n" + getSpacer().repeat(2), "$2\n" + getSpacer() + "]\n)", getSpacer().repeat(2))
	));
	context.subscriptions.push(commands.registerCommand('extension.wrapInRow', () =>
		insertSnippet("${1:Row}(\n" + getSpacer() + "children: [\n" + getSpacer().repeat(2), "$2\n" + getSpacer() + "]\n)", getSpacer().repeat(2))
	));
	context.subscriptions.push(commands.registerCommand('extension.wrapInListView', () =>
		insertSnippet("${1:ListView}(\n" + getSpacer() + "children: [\n" + getSpacer().repeat(2), "$2\n" + getSpacer() + "]\n)", getSpacer().repeat(2))
	));
	context.subscriptions.push(commands.registerCommand('extension.wrapInPositioned', () =>
		insertSnippet("${1:Positioned}(\n" + getSpacer() + "child: $2", "\n)", getSpacer())
	));
	context.subscriptions.push(commands.registerCommand('extension.wrapInExpanded', () =>
		insertSnippet("${1:Expanded}(\n" + getSpacer() + "child: $2", "\n)", getSpacer())
	));
	context.subscriptions.push(commands.registerCommand('extension.wrapInText', () =>
